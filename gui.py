...
def home_page(root):
    ...
    tk.Button(root, text="Shift and Fold", bg="#E7DECC", fg="#1569C7", font=("Helvetica", 12), command=lambda: sfrun(root)).pack(pady=15)
    tk.Button(root, text="DerivativeSignal", bg="#E7DECC", fg="#1569C7", font=("Helvetica", 12), command=lambda: DerivativeSignal(root)).pack(pady=15)
